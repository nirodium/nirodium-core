...
static std::string ValueToString(CAmount nValue, bool AllowNegative = false)
{
    ...
    QString Str = BitcoinUnits::formatWithUnit(BitcoinUnits::NRDI, nValue);
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", true)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (nirodium.conf).");
            QMessageBox::warning(this, "Nirodium Core Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
...
{
    //#093c01
    QString CSS = "body {font-size:12px; color:#f8f6f6;}\n a, span { font-family: monospace; }\n span.addr {color:#0f6702; font-weight: bold;}\n table tr td {padding: 3px; color:#fff; background-color:#0f6702;}\n td.d0 {font-weight: bold;}\n h2, h3 { white-space:nowrap; color:#093c01;}\n a { color:#88f6f6; text-decoration:none; }\n a.nav {color:#0f6702;}\n";
