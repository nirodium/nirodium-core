...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Nirodium Core"),
     ...
     * override -datadir in the nirodium.conf file in the default data directory
     * (to be consistent with nirodiumd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
