...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::NRDI);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeNirodiumAmount"))
        SoftSetArg("-anonymizenirodiumamount", settings.value("nAnonymizeNirodiumAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in nirodium.cpp during shotdown to also remove the window positions
