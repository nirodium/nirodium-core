                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzNRDIPathCustom = GetArg("-znrdibackuppath", "");
    ...
    if(!strzNRDIPathCustom.empty()) {
        ui->wallet_customznrdibackuppath->setText(QString::fromStdString(strzNRDIPathCustom));
        ui->wallet_customznrdibackuppath_label->setVisible(true);
        ui->wallet_customznrdibackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzNRDIPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the NRDI RPC console.") + "<br>" +
