...
/** Utility functions used by the NRDI Qt UI.
 */
namespace GUIUtil
{
...
// Render NRDI addresses in monospace font
...
// Parse "nirodium:" URI into recipient object, return true on successful parsing
