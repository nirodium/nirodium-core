...
#ifndef NRDI_ZNRDITRACKER_H
#define NRDI_ZNRDITRACKER_H
...
public:
    CzNRDITracker(std::string strWalletFile);
    ~CzNRDITracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzNRDIWallet* zNRDIWallet = NULL);
