...
#ifndef NRDI_ZNRDIWALLET_H
#define NRDI_ZNRDIWALLET_H
...
public:
    CzNRDIWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZNRDI(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZNRDI(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
