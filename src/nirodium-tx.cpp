...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Nirodium Core nirodium-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  nirodium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nirodium transaction") + "\n" +
                               "  nirodium-tx [options] -create [commands]   " + _("Create hex-encoded nirodium transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nirodium transaction
