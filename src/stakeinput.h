...
#ifndef NRDI_STAKEINPUT_H
#define NRDI_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZNRDI() = 0;
    virtual CDataStream GetUniqueness() = 0;
    virtual uint256 GetSerialHash() const = 0;
};


// zNRDIStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked znrdi, which is a zcspend that has successfully staked
...
public:
    ...
    bool IsZNRDI() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZNRDI() override { return false; }
    uint256 GetSerialHash() const override { return uint256(0); }
};


#endif //NRDI_STAKEINPUT_H
