...
UniValue preparebudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 6)
        throw runtime_error(
            "preparebudget \"proposal-name\" \"url\" payment-count block-start \"nirodium-address\" monthy-payment\n"
            ...
            "5. \"nirodium-address\":   (string, required) NRDI address to send payments to\n"
            ...
            "\nExamples:\n" +
            HelpExampleCli("preparebudget", "\"test-proposal\" \"https://forum.nirodium.org/t/test-proposal\" 2 820800 \"n9d1RVg6S6Yvkksf55JCuidgo4hcUZ2tcr\" 500") +
            HelpExampleRpc("preparebudget", "\"test-proposal\" \"https://forum.nirodium.org/t/test-proposal\" 2 820800 \"n9d1RVg6S6Yvkksf55JCuidgo4hcUZ2tcr\" 500"));
    ...
    CWalletTx wtx;
    if (!pwalletMain->GetBudgetSystemCollateralTX(wtx, budgetProposalBroadcast.GetHash(), useIX)) { // 50 NRDI collateral for proposal
...
UniValue submitbudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 7)
        throw runtime_error(
            "submitbudget \"proposal-name\" \"url\" payment-count block-start \"nirodium-address\" monthy-payment \"fee-tx\"\n"
            ...
            "\nExamples:\n" +
            HelpExampleCli("submitbudget", "\"test-proposal\" \"https://forum.nirodium.org/t/test-proposal\" 2 820800 \"n9d1RVg6S6Yvkksf55JCuidgo4hcUZ2tcr\" 500") +
            HelpExampleRpc("submitbudget", "\"test-proposal\" \"https://forum.nirodium.org/t/test-proposal\" 2 820800 \"n9d1RVg6S6Yvkksf55JCuidgo4hcUZ2tcr\" 500"));
...
UniValue getbudgetprojection(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "    \"PaymentAddress\": \"xxxx\",     (string) NRDI address of payment\n"
