...
// extern UniValue bip38encrypt(const UniValue& params, bool fHelp); // hidden for staking bug
// extern UniValue bip38decrypt(const UniValue& params, bool fHelp); // hidden for staking bug
...
// extern UniValue encryptwallet(const UniValue& params, bool fHelp); // hidden for staking bug
...
extern UniValue setznrdiseed(const UniValue& params, bool fHelp);
extern UniValue getznrdiseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdznrdi(const UniValue& params, bool fHelp);
extern UniValue dznrdistate(const UniValue& params, bool fHelp);
