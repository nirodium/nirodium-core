...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* NRDI features */
        {"nirodium", "listmasternodes", &listmasternodes, true, true, false},
        {"nirodium", "getmasternodecount", &getmasternodecount, true, true, false},
        {"nirodium", "masternodeconnect", &masternodeconnect, true, true, false},
        {"nirodium", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"nirodium", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"nirodium", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"nirodium", "masternodecurrent", &masternodecurrent, true, true, false},
        {"nirodium", "masternodedebug", &masternodedebug, true, true, false},
        {"nirodium", "startmasternode", &startmasternode, true, true, false},
        {"nirodium", "createmasternodekey", &createmasternodekey, true, true, false},
        {"nirodium", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"nirodium", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"nirodium", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"nirodium", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"nirodium", "getmasternodescores", &getmasternodescores, true, true, false},
        {"nirodium", "preparebudget", &preparebudget, true, true, false},
        {"nirodium", "submitbudget", &submitbudget, true, true, false},
        {"nirodium", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"nirodium", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"nirodium", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"nirodium", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"nirodium", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"nirodium", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"nirodium", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"nirodium", "checkbudgets", &checkbudgets, true, true, false},
        {"nirodium", "mnsync", &mnsync, true, true, false},
        {"nirodium", "spork", &spork, true, true, false},
        {"nirodium", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        // {"wallet", "bip38encrypt", &bip38encrypt, true, false, true}, // hidden for staking bug
        // {"wallet", "bip38decrypt", &bip38decrypt, true, false, true}, // hidden for staking bug
        // {"wallet", "encryptwallet", &encryptwallet, true, false, true}, // hidden for staking bug
        ...
        {"zerocoin", "getznrdiseed", &getznrdiseed, false, false, true},
        {"zerocoin", "setznrdiseed", &setznrdiseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdznrdi", &searchdznrdi, false, false, true},
        {"zerocoin", "dznrdistate", &dznrdistate, false, false, true},
        {"zerocoin", "clearspendcache", &clearspendcache, false, false, true} */

#endif // ENABLE_WALLET //hide zPrivacy
};
...
{
    return "> nirodium-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:61101/\n";
}
